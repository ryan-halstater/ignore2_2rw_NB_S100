...
static const std::vector<string> locations_array__ = {" (found before start of program)",
                                                      ...
                                                      " (in 'string', line 61, column 2 to column 40)",
                                                      ...
                                                      " (in 'string', line 23, column 14 to column 15)",
...
public:
  ...
  model_lc_two_walks(stan::io::var_context& context__,
    ...
    try {
      ...
      validate_unit_vector_index("b1", "J", J);
      current_statement__ = 100;
      validate_unit_vector_index("b2", "J", J);
    ...
    try {
      ...
      if (jacobian__) {
        ...
        assign(b1, nil_index_list(),
          stan::math::unit_vector_constrain(b1, lp__),
          "assigning variable b1");
      } else {
        current_statement__ = 3;
        assign(b1, nil_index_list(), stan::math::unit_vector_constrain(b1),
          "assigning variable b1");
      }
      ...
      if (jacobian__) {
        ...
        assign(b2, nil_index_list(),
          stan::math::unit_vector_constrain(b2, lp__),
          "assigning variable b2");
      } else {
        current_statement__ = 4;
        assign(b2, nil_index_list(), stan::math::unit_vector_constrain(b2),
          "assigning variable b2");
      }
      local_scalar_t__ c1;
      c1 = DUMMY_VAR__;
      ...
      } 
      {
        ...
        lp_accum__.add(normal_lpdf<false>(c1, 0, stan::math::sqrt(0.3)));
        current_statement__ = 71;
        lp_accum__.add(normal_lpdf<false>(c2, 0, stan::math::sqrt(0.3)));
        current_statement__ = 72;
        lp_accum__.add(normal_lpdf<false>(b1, 0, stan::math::sqrt(10)));
        current_statement__ = 73;
        lp_accum__.add(normal_lpdf<false>(b2, 0, stan::math::sqrt(10)));
...
(void) function__;  // suppress unused var warning
  ...
  inline void transform_inits_impl(const stan::io::var_context& context__,
    ...
    try {
      ...
      b1_free__ = Eigen::Matrix<double, -1, 1>(J);
      stan::math::fill(b1_free__, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 3;
      assign(b1_free__, nil_index_list(), stan::math::unit_vector_free(b1),
      ...
      b2_free__ = Eigen::Matrix<double, -1, 1>(J);
      stan::math::fill(b2_free__, std::numeric_limits<double>::quiet_NaN());
      
      current_statement__ = 4;
      assign(b2_free__, nil_index_list(), stan::math::unit_vector_free(b2),
